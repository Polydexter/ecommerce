...
class ProductType(models.Model):
    """
    ProductType table provides a list of the different types
...
class ProductSpecification(models.Model):
    """
    ProductSpecification table contains specific
    product features for different product types
    """
...
class Product(models.Model):
    """
    Product table contains all product items
    """
    ...
    is_active = models.BooleanField(
        ...
        help_text=_("Control product visibility"),
        default=True,
    )
...
class ProductSpecificationValue(models.Model):
    """
    Product Specification Value table holds each
    of the products individual features
    """
...
class ProductImage(models.Model):
    ...
    alt_text = models.CharField(
        verbose_name=_("Alternatice text"),
