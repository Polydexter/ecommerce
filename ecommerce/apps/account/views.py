...
from ecommerce.apps.order.views import user_orders
...
def address_add(request):
    if request.method == "POST":
        ...
        if address_form.is_valid():
            ...
            messages.success(request, "Please check your information and try again")
    address_form = UserAddressForm()
    return render(
        request, "account/dashboard/edit_address.html", {"form": address_form}
    )
...
def address_set_default(request, id):
    ...
    # Handle requests coming from checkout zone
